...
df = pd.read_csv(r'C:\\Users\\vigne\\OneDrive\\Desktop\\food recapp\\minor\\website\\dataset.csv')
...
def Recommend(request):
    ...
    if request.user.is_authenticated:
        class Recommender:
            ...
            def __init__(self):
                self.df = pd.read_csv(r'C:\\Users\\vigne\\OneDrive\\Desktop\\food recapp\\minor\\website\\dataset.csv')
