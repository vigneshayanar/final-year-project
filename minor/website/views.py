...
def buy(request):
    ...
    filename=r"C:\\Users\\vigne\\OneDrive\\Desktop\\food recapp\\minor\\website\\csvfile\\recent_activity.csv"
...
def order(request):
    if Profile.objects.get(number=request.user.username).second_time:
        filename=r"C:\\Users\\vigne\\OneDrive\\Desktop\\food recapp\\minor\\website\\csvfile\\recent_activity.csv"
        filename2=r"C:\\Users\\vigne\\OneDrive\\Desktop\\food recapp\\minor\\website\\dataset.csv"
