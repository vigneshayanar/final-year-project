...
def Recommend(request):
    if request.user.is_authenticated:   
        ...
        profiles = pd.read_csv(r'C:\\Users\\vigne\\OneDrive\\Desktop\\food recapp\\minor\\website\\csvfile\\user_Profiles.csv') # profiles of all users
        recent_activity = pd.read_csv(r'C:\\Users\\vigne\\OneDrive\\Desktop\\food recapp\\minor\\website\\csvfile\\recent_activity.csv') # recent activities of current user (meals liked,rated,searched,Purchased)
        dataset = pd.read_csv(r'C:\\Users\\vigne\\OneDrive\\Desktop\\food recapp\\minor\\website\\dataset.csv') # main dataset
